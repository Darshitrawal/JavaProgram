...
public class DAO{
  ...
  public static void initData(){
    students.add(new Student(1, 50, "Darshit", "CE", 5, 4));
    students.add(new Student(2, 03, "Abhishek", "CE", 5, 4));
    students.add(new Student(3, 38, "Parth", "CE", 5, 4));
    students.add(new Student(4, 37, "Rushi", "CE", 5, 4));
    students.add(new Student(5, 27, "Kuldip", "CE", 5, 4));

    staffs.add(new Staff(1, "Girishsir", "CE", "Professor", 6));
    staffs.add(new Staff(2, "Sagarsir", "CE", "Professor", 6));
    staffs.add(new Staff(3, "Dipeshsir", "CE", "Professor", 6));
    staffs.add(new Staff(4, "Virajsir", "CE", "Professor", 6));
    staffs.add(new Staff(5, "Tejassir", "CE", "HOD", 6));
